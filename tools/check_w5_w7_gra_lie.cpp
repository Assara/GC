...
int main() {
	...
	const auto pre_5_7 = coalgebra_utils::gra_pre_lie(w5, w7);
	const auto pre_7_5 = coalgebra_utils::gra_pre_lie(w7, w5);
	...
	std::cout << "pre_5_7 terms: " << pre_5_7.data().size() << '\n';
	std::cout << "pre_7_5 terms: " << pre_7_5.data().size() << '\n';
	std::cout << "lie terms: " << lie.data().size() << '\n';
	std::cout << "raw d(pre_5_7) terms: " << raw_d_pre_5_7.size() << '\n';
	std::cout << "raw d(pre_7_5) terms: " << raw_d_pre_7_5.size() << '\n';
	std::cout << "standardised d(pre_5_7) terms: " << d_pre_5_7.data().size() << '\n';
	std::cout << "standardised d(pre_7_5) terms: " << d_pre_7_5.data().size() << '\n';
	std::cout << "common standardised terms in the two pre-Lie differentials: "
		  << overlap_count(d_pre_5_7.data(), d_pre_7_5.data()) << '\n';
	std::cout << "raw d(lie) terms: " << raw_d_lie.size() << '\n';
	std::cout << "standardised d(lie) terms: " << d_lie.data().size() << '\n';
	std::cout << "d(lie) is zero: " << (d_lie.data().size() == 0 ? "yes" : "no") << '\n';
